...
hl.bind("Print", hl.dsp.exec_cmd("~/.local/bin/hyprshot monitor"))
hl.bind("SUPER + Print", hl.dsp.exec_cmd("~/.local/bin/hyprshot window"))
hl.bind("SUPER + SHIFT + Print", hl.dsp.exec_cmd("~/.local/bin/hyprshot region"))
hl.bind("ALT + Print", hl.dsp.exec_cmd("~/.local/bin/hyprshot pixel"))
